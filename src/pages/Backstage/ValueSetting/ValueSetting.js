...
const ValueSetting=(props)=> {
    ...
    return (
        ...
        <AccordionDetails className="listContent">
            <div className="setlist"><h4 className="settitle">賣方商品成本</h4><Input className="input"/></div>
            <div className="setlist"><h4 className="settitle">買方商品價值</h4><Input className="input"/></div>
